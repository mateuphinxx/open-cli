...
- **Components** → components plugins go to `components/` folder
- **Plugins** → Legacy plugins go to `plugins/` folder
...
- **Root Libraries** → Files containing "amx" or "lib" (like `amxsscanf.dll`) → root directory
